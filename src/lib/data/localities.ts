...
export const localities: Locality[] = [
  ...
  // Added for denser, more hyperlocal coverage — aiming for every part of Bengaluru to have a
  // scored locality within roughly 3km, not just the original 31 well-known hubs.
  { id: 'loc-jakkur', name: 'Jakkur', lat: 13.0810, lng: 77.6080, type: 'mixed', populationDensityPerSqKm: 9500 },
  { id: 'loc-hennur', name: 'Hennur', lat: 13.0450, lng: 77.6350, type: 'mixed', populationDensityPerSqKm: 16500 },
  { id: 'loc-thanisandra', name: 'Thanisandra', lat: 13.0640, lng: 77.6220, type: 'residential', populationDensityPerSqKm: 12500 },
  { id: 'loc-horamavu', name: 'Horamavu', lat: 13.0330, lng: 77.6470, type: 'residential', populationDensityPerSqKm: 14500 },
  { id: 'loc-banaswadi', name: 'Banaswadi', lat: 13.0140, lng: 77.6520, type: 'mixed', populationDensityPerSqKm: 17500 },
  { id: 'loc-kalyan-nagar', name: 'Kalyan Nagar', lat: 13.0230, lng: 77.6390, type: 'mixed', populationDensityPerSqKm: 17000 },
  { id: 'loc-ramamurthy-nagar', name: 'Ramamurthy Nagar', lat: 13.0180, lng: 77.6650, type: 'residential', populationDensityPerSqKm: 15500 },
  { id: 'loc-kr-puram', name: 'KR Puram', lat: 12.9950, lng: 77.6950, type: 'mixed', populationDensityPerSqKm: 14000 },
  { id: 'loc-mahadevapura', name: 'Mahadevapura', lat: 12.9820, lng: 77.6980, type: 'commercial', populationDensityPerSqKm: 12000 },
  { id: 'loc-hoodi', name: 'Hoodi', lat: 12.9900, lng: 77.7150, type: 'mixed', populationDensityPerSqKm: 11000 },
  { id: 'loc-varthur', name: 'Varthur', lat: 12.9420, lng: 77.7420, type: 'mixed', populationDensityPerSqKm: 9500 },
  { id: 'loc-kadugodi', name: 'Kadugodi', lat: 12.9930, lng: 77.7620, type: 'residential', populationDensityPerSqKm: 7500 },
  { id: 'loc-uttarahalli', name: 'Uttarahalli', lat: 12.9080, lng: 77.5450, type: 'residential', populationDensityPerSqKm: 12500 },
  { id: 'loc-yelachenahalli', name: 'Yelachenahalli', lat: 12.8930, lng: 77.5650, type: 'residential', populationDensityPerSqKm: 13500 },
  { id: 'loc-konanakunte', name: 'Konanakunte', lat: 12.8850, lng: 77.5580, type: 'residential', populationDensityPerSqKm: 11500 },
  { id: 'loc-anjanapura', name: 'Anjanapura', lat: 12.8720, lng: 77.5620, type: 'residential', populationDensityPerSqKm: 9500 },
  { id: 'loc-begur', name: 'Begur', lat: 12.8720, lng: 77.6320, type: 'residential', populationDensityPerSqKm: 10500 },
  { id: 'loc-hulimavu', name: 'Hulimavu', lat: 12.8850, lng: 77.6020, type: 'residential', populationDensityPerSqKm: 13500 },
  { id: 'loc-chandapura', name: 'Chandapura', lat: 12.7950, lng: 77.7050, type: 'industrial', populationDensityPerSqKm: 7000 },
  { id: 'loc-kumaraswamy-layout', name: 'Kumaraswamy Layout', lat: 12.9050, lng: 77.5580, type: 'residential', populationDensityPerSqKm: 14500 },
  { id: 'loc-rajarajeshwari-nagar', name: 'Rajarajeshwari Nagar', lat: 12.9270, lng: 77.5180, type: 'residential', populationDensityPerSqKm: 12500 },
  { id: 'loc-nayandahalli', name: 'Nayandahalli', lat: 12.9420, lng: 77.5350, type: 'mixed', populationDensityPerSqKm: 15500 },
  { id: 'loc-richmond-town', name: 'Richmond Town', lat: 12.9620, lng: 77.6040, type: 'mixed', populationDensityPerSqKm: 19500 },
  { id: 'loc-frazer-town', name: 'Frazer Town', lat: 12.9970, lng: 77.6110, type: 'mixed', populationDensityPerSqKm: 20500 },
  { id: 'loc-wilson-garden', name: 'Wilson Garden', lat: 12.9470, lng: 77.5960, type: 'residential', populationDensityPerSqKm: 18500 },
  { id: 'loc-chickpet', name: 'Chickpet', lat: 12.9700, lng: 77.5760, type: 'commercial', populationDensityPerSqKm: 23500 },
];
