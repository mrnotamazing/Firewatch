        ...
        <div className="mx-auto max-w-[1200px]">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {HOW_IT_WORKS.map((step, i) => {
              ...
              return (
                <div key={step.title} className="border border-line p-5">
      ...
      <section className="border-b border-ink bg-paper-2 px-6 py-14">
        <div className="mx-auto max-w-[1200px]">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Link to="/heatmap" className="group flex flex-col justify-between border border-ink bg-paper p-6 shadow-sm transition-shadow hover:shadow-md">
              <div>
            ...
            <Link to="/report" className="group flex flex-col justify-between border border-ink bg-paper p-6 shadow-sm transition-shadow hover:shadow-md">
              <div>
            ...
            <Link to="/accountability" className="group flex flex-col justify-between border border-ink bg-paper p-6 shadow-sm transition-shadow hover:shadow-md">
              <div>
            ...
            <Link to="/gallery" className="group flex flex-col justify-between border border-ink bg-paper p-6 shadow-sm transition-shadow hover:shadow-md">
              <div>
